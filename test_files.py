...
def txt_descr(txt_id, txt_pl, txt_eng, txt_nor):
    ...
    return txt
#creates reply form of the type qualtrics link
def qual_descr(qual_id):
    qual = {
                    ...
                    "description": [
                        {
                            "language": "eng",
                            "text": "Additional question on WWW page"
                        },
                        {
                            "language": "pol",
...
#in case you have many services, use this + have seperate video folders for each service:
many_services = 0
...
#tags mean - 1: many services; 0: only one service
tags = []
# 0: no reply form, 1: reply form
reply = []
#example of questions - you can pick your own text
...
list_of_reply_list = [reply_list1]

#specify path with your testers schedules and videos you want to upload now
#HERE you modify file paths
schedule_file = "/Users/nataliacieplinska/Documents/schedules_tests_only"
video_file = "/Users/nataliacieplinska/Documents/schedules_tests_only/videos"
...
#if you want to keep previous data: 0, if you want to clear previous schedule: 1
clear_schedule = 1
